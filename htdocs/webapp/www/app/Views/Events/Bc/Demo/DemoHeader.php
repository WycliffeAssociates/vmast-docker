...
<div id="translator_steps" class="open pray <?php echo $data["isCheckerPage"] ? " is_checker_page".($data["isPeerPage"] ? " isPeer" : "") : "" ?>">
    ...
    <ul class="steps_list">
        <li class="pray-step <?php echo $data["step"] == EventSteps::PRAY ? "active" : "" ?>">
            <a href="/events/demo-bc/pray<?php echo $chk ?>"><span><?php echo __(EventSteps::PRAY)?></span></a>
        </li>

        <?php if(!$data["isCheckerPage"]): ?>
        <li class="multi-draft-step <?php echo $data["step"] == EventSteps::MULTI_DRAFT ? "active" : "" ?>">
            <a href="/events/demo-bc/multi_draft"><span><?php echo __(EventSteps::MULTI_DRAFT)?></span></a>
        </li>

        <li class="self-check-step <?php echo $data["step"] == EventSteps::SELF_CHECK ? "active" : "" ?>">
            <a href="/events/demo-bc/self_check"><span><?php echo __(EventSteps::SELF_CHECK)?></span></a>
        </li>
        <?php endif; ?>

        <?php if($data["isCheckerPage"]): ?>
        <li class="keyword-check-step <?php echo $data["step"] == EventSteps::KEYWORD_CHECK ? "active" : "" ?>">
            <a href="/events/demo-bc/keyword_check"><span><?php echo __(EventSteps::KEYWORD_CHECK)?></span></a>
        </li>

        <li class="peer-review-step <?php echo $data["step"] == EventSteps::PEER_REVIEW ? "active" : "" ?>">
            <a href="/events/demo-bc/peer_review"><span><?php echo __(EventSteps::PEER_REVIEW . "_bc")?></span></a>
        </li>
        <?php endif; ?>
    </ul>
</div>
