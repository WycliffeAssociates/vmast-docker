                ...
                <div class="no_padding">
                    ...
                    <div class="row chunk_block">
                        <div class="flex_container">
                            <div class="chunk_verses flex_left" dir="ltr">
                                <p class="verse_text" data-verse="1" style="height: 37px;">
                                    <strong class="ltr">
                                        <sup>1</sup>
                                    </strong>
                                    You therefore, my child, be strengthened in the grace that is in Christ Jesus.                                        </p>
                                <p class="verse_text" data-verse="2" style="height: 74px;">
                                    <strong class="ltr">
                                        <sup>2</sup>
                                    </strong>
                            ...
                            <div class="flex_middle editor_area sun_content">
                                <div class="verse_block flex_chunk" data-verse="1" style="height: 37px;">
                                                                                     </div>
                                <div class="verse_block flex_chunk" data-verse="2" style="height: 74px;">
                                                                                                  </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row chunk_block">
                        <div class="flex_container">
                            ...
                            <div class="flex_middle editor_area sun_content">
                                <div class="verse_block flex_chunk" data-verse="3" style="height: 37px;">
                                                                                       </div>
                                <div class="verse_block flex_chunk" data-verse="4" style="height: 40px;">
                                                                                          </div>
                                <div class="verse_block flex_chunk" data-verse="5" style="height: 40px;">
                                                                                         </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row chunk_block">
                        <div class="flex_container">
                            <div class="chunk_verses flex_left" dir="ltr">
                                <p class="verse_text" data-verse="6" style="height: 37px;">
                                    <strong class="ltr">
                                        <sup>6</sup>
                                    </strong>
                                    It is necessary that the hardworking farmer receive his share of the crops first.                                        </p>
                                <p class="verse_text" data-verse="7" style="height: 37px;">
                                    <strong class="ltr">
                                        <sup>7</sup>
                                    </strong>
                            ...
                            <div class="flex_middle editor_area sun_content">
                                <div class="verse_block flex_chunk" data-verse="6" style="height: 37px;">
                                                                                       </div>
                                <div class="verse_block flex_chunk" data-verse="7" style="height: 37px;">
                                                                                      </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row chunk_block">
                        <div class="flex_container">
                            ...
                            <div class="flex_middle editor_area sun_content">
                                <div class="verse_block flex_chunk" data-verse="8" style="height: 40px;">
                                       ,                                                   </div>
                                <div class="verse_block flex_chunk" data-verse="9" style="height: 74px;">
                                                                                              </div>
                                <div class="verse_block flex_chunk" data-verse="10" style="height: 74px;">
                                                                                                  </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row chunk_block">
                        <div class="flex_container">
                            <div class="chunk_verses flex_left" dir="ltr">
                                <p class="verse_text" data-verse="11" style="height: 74px;">
                                    <strong class="ltr">
                                        <sup>11</sup>
                                    </strong>
                                ...
                                <p class="verse_text" data-verse="13" style="height: 37px;">
                                    <strong class="ltr">
                                        <sup>13</sup>
                                    </strong>
                            ...
                            <div class="flex_middle editor_area sun_content">
                                <div class="verse_block flex_chunk" data-verse="11" style="height: 74px;">
                                                                                          </div>
                                <div class="verse_block flex_chunk" data-verse="12" style="height: 74px;">
                                       ,          ,                                            </div>
                                <div class="verse_block flex_chunk" data-verse="13" style="height: 37px;">
                                        ,                                                  </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row chunk_block">
                        <div class="flex_container">
                            <div class="chunk_verses flex_left" dir="ltr">
                                <p class="verse_text" data-verse="14" style="height: 74px;">
                                    <strong class="ltr">
                                        <sup>14</sup>
                                    </strong>
                                ...
                                <p class="verse_text" data-verse="15" style="height: 74px;">
                                    <strong class="ltr">
                                        <sup>15</sup>
                                    </strong>
                            ...
                            <div class="flex_middle editor_area sun_content">
                                <div class="verse_block flex_chunk" data-verse="14" style="height: 74px;">
                                                                                                     </div>
                                <div class="verse_block flex_chunk" data-verse="15" style="height: 74px;">
                                                                                                 </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row chunk_block">
                        <div class="flex_container">
                            <div class="chunk_verses flex_left" dir="ltr">
                                <p class="verse_text" data-verse="16" style="height: 37px;">
                                    <strong class="ltr">
                                        <sup>16</sup>
                                    </strong>
                                    Avoid profane talk, which leads to more and more godlessness.                                        </p>
                                <p class="verse_text" data-verse="17" style="height: 37px;">
                                    <strong class="ltr">
                                        <sup>17</sup>
                                    </strong>
                                    Their talk will spread like cancer. Among them are Hymenaeus and Philetus,                                        </p>
                                <p class="verse_text" data-verse="18" style="height: 40px;">
                                    <strong class="ltr">
                                        <sup>18</sup>
                                    </strong>
                            ...
                            <div class="flex_middle editor_area sun_content">
                                <div class="verse_block flex_chunk" data-verse="16" style="height: 37px;">
                                        ,                                                  </div>
                                <div class="verse_block flex_chunk" data-verse="17" style="height: 37px;">
                                                                                       </div>
                                <div class="verse_block flex_chunk" data-verse="18" style="height: 40px;">
                                                                                           </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row chunk_block">
                        <div class="flex_container">
                            <div class="chunk_verses flex_left" dir="ltr">
                                ...
                                <p class="verse_text" data-verse="20" style="height: 74px;">
                                    <strong class="ltr">
                                        <sup>20</sup>
                                    </strong>
                                ...
                                <p class="verse_text" data-verse="21" style="height: 74px;">
                                    <strong class="ltr">
                                        <sup>21</sup>
                                    </strong>
                            ...
                            <div class="flex_middle editor_area sun_content">
                                <div class="verse_block flex_chunk" data-verse="19" style="height: 111px;">
                                           ,                                                         </div>
                                <div class="verse_block flex_chunk" data-verse="20" style="height: 74px;">
                                                                                                      </div>
                                <div class="verse_block flex_chunk" data-verse="21" style="height: 74px;">
                                                                                                   </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row chunk_block">
                        <div class="flex_container">
                            ...
                            <div class="flex_middle editor_area sun_content">
                                <div class="verse_block flex_chunk" data-verse="22" style="height: 74px;">
                                            ,  ,                                                        </div>
                                <div class="verse_block flex_chunk" data-verse="23" style="height: 40px;">
                                                                                        </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row chunk_block">
                        <div class="flex_container">
                            ...
                            <div class="flex_middle editor_area sun_content">
                                <div class="verse_block flex_chunk" data-verse="24" style="height: 74px;">
                                                                                             </div>
                                <div class="verse_block flex_chunk" data-verse="25" style="height: 74px;">
                                                                                              </div>
                                <div class="verse_block flex_chunk" data-verse="26" style="height: 40px;">
                                                                                         </div>
                            </div>
                        </div>
                    </div>
