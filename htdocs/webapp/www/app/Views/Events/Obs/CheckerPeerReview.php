                        ...
                        <div class="flex_container">
                            <div class="chunk_verses flex_left" dir="<?php echo $data["event"][0]->resLangDir ?>">
                                <div class="resource_chunk no_margin" data-chunk="<?php echo $chunkNo ?>">
                                    <div class="resource_text"><?php echo $data["obs"]->get($chunkNo)->text ?></div>
                                    <?php if ($data["obs"]->get($chunkNo)->type == ResourceChunkType::IMAGE): ?>
                                        <div class="obs_img mdi mdi-image" data-img="<?php echo $data["obs"]->get($chunkNo)->meta ?>"></div>
                                    <?php endif; ?>
                                </div>
                            </div>
