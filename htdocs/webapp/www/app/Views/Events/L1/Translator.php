...
<div id="translator_steps" class="open <?php echo $data["event"][0]->step . (isset($data["isCheckerPage"]) ? " is_checker_page" : "") ?>">
    ...
    <ul class="steps_list">
        ...
        <?php if (in_array($data["event"][0]->inputMode, [InputMode::SCRIPTURE_INPUT, InputMode::SPEECH_TO_TEXT])): ?>
        ...
        <?php if ($data["event"][0]->inputMode == InputMode::NORMAL): ?>
        ...
        <?php if (in_array($data["event"][0]->inputMode, [InputMode::NORMAL, InputMode::SPEECH_TO_TEXT])): ?>
