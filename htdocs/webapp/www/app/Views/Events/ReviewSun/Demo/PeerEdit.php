...
<div class="content_help closed">
    ...
    <div class="help_float">
        ...
        <div class="checker_view">
            <a href="/events/demo-sun-review/peer_edit_l3_checker"><?php echo __("checker_other_view", [2]) ?></a>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function () {
        $("#next_step").click(function (e) {
            e.preventDefault();
            if (!hasChangesOnPage) window.location.href = '/events/demo-sun-review/pray';
            return false;
        });
