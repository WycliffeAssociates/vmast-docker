    ...
    <div class="help_float">
        <div class="help_info_steps is_checker_page_help">
            ...
            <div class="help_descr_steps">
                <ul>
                    <li><b><?php echo __("purpose") ?></b> <?php echo __("keyword-check_tq_purpose") ?></li>
                    <li><?php echo __("keyword-check_tq_help_1") ?></li>
                    ...
                    <li><?php echo __("keyword-check_tq_help_5", ["icon" => "<span class='mdi mdi-lead-pencil'></span>"]) ?></li>
