                            ...
                            <div class="flex_container">
                                ...
                                <div class="font_ru flex_middle" dir="ltr">
                                    <div><h1>Как Иоанн молится о Гаие?</h1>
                                        <p>Иоанн молится, чтобы Гаий преуспевал и здравствовал так же, как преуспевает
                                            его душа.</p></div>
                            ...
                            <div class="flex_container">
                                ...
                                <div class="font_ru flex_middle" dir="ltr">
                                    <div><h1>Что намерен сделать Иоанн, когда придет к Гаию и другим членам общины?</h1>
                                        ...
                                        <p>Он запрещает братьям принимать Божьих служителей, а тех, кто его ослушался,
                                            выгоняет из общины.</p></div>
