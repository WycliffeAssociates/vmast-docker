...
<div id="translator_steps" class="open pray is_checker_page <?php echo $data["isPeer"] ? " isPeer" : "" ?>">
    ...
    <ul class="steps_list">
        <li class="pray-step <?php echo $data["step"] == EventCheckSteps::PRAY ? "active" : "" ?>">
            <a href="/events/demo-tn-review/pray"><span><?php echo __(EventCheckSteps::PRAY)?></span></a>
        </li>

        <li class="consume-step <?php echo $data["step"] == EventCheckSteps::PEER_REVIEW_L3 ? "active" : "" ?>">
            <a href="/events/demo-tn-review/peer_review_l3"><span><?php echo __(EventCheckSteps::PEER_REVIEW_L3)?></span></a>
        </li>

        <li class="self-check-step <?php echo $data["step"] == EventCheckSteps::PEER_EDIT_L3 ? "active" : "" ?>">
            <a href="/events/demo-tn-review/peer_edit_l3"><span><?php echo __(EventCheckSteps::PEER_EDIT_L3)?></span></a>
        </li>
    </ul>
</div>
