...
return array(
    ...
    "checkerJoined" => "Checker ({name}) has accepted your request",
    "checkerApproved" => "Checker ({name}) has approved this step!",
    "assign" => "Assign",
    "chapters" => "Chapters",
    ...
    "startTranslationConfirm" => "Are you sure you want to start the book?",
    ...
    "applyForEventConfirm" => "Do you really want to apply for this book?",
