...
<div id="translator_steps" class="open pray <?php echo $data["isCheckerPage"] ? " is_checker_page".($data["isPeerPage"] ? " isPeer" : "") : "" ?>">
    ...
    <div class="sun_mode demo_sun_mode <?php echo $data["isCheckerPage"] ? " is_checker_page".($data["isPeerPage"] ? " isPeer" : "") : "" ?>">
        <label><?php echo __("sun_mode") ?>
            <input type="checkbox" autocomplete="off"
                   <?php echo isset($_COOKIE["sun_mode"]) ? "checked" : "" ?>
                   data-toggle="toggle"
                   data-on="ON"
                   data-off="OFF" />
        </label>
