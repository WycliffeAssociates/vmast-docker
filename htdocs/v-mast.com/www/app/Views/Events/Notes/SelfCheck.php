...
<div id="translator_contents" class="row panel-body">
    <div class="row main_content_header">
        <div class="main_content_title"><?php echo __("step_num", ["step_number" => 3]) . ": " . __("self-check_tn")?></div>
    </div>
...
<div class="content_help closed">
    ...
    <div class="help_float">
        <div class="help_info_steps">
            <div class="help_name_steps"><span><?php echo __("step_num", ["step_number" => 3])?>: </span><?php echo __("self-check_tn")?></div>
            <div class="help_descr_steps">
                <ul>
                    <li><b><?php echo __("purpose") ?></b> <?php echo __("self-check_tn_purpose") ?></li>
                    ...
                    <li><?php echo __("self-check_tn_help_5") ?></li>
                    <li><?php echo __("blind-draft_tn_help_8", ["icon" => "<i class='note-icon-magic'></i>"]) ?>
                        <ol>
                            <li><?php echo __("self-check_tn_help_6a") ?></li>
                            <li><?php echo __("self-check_tn_help_6b") ?></li>
                            <li><?php echo __("blind-draft_tn_help_8c") ?></li>
                        </ol>
                    </li>
                    <li><?php echo __("self-check_tn_help_7", ["icon" => "<span class='mdi mdi-lead-pencil'></span>"]) ?></li>
