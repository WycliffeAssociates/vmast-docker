...
<div style="margin-bottom: 20px">
    ...
    <div class="demo_title events_index">
        ...
        <div class="demo_options">
            <ul>
                <a href="/events/demo">
                    <li><?php echo __("8steps_vmast") ?></li>
                </a>
                <a href="/events/demo-scripture-input">
                    <li><?php echo __("scripture-input") ?></li>
                </a>
                <a href="/events/demo-speech-to-text">
                    <li><?php echo __("speech-to-text") ?></li>
                </a>
                <a href="/events/demo-revision">
                    <li><?php echo __("revision_events"); ?></li>
                </a>
                <a href="/events/demo-review">
                    <li><?php echo __("review_events") ?></li>
                </a>
                <a href="/events/demo-tn">
                    <li><?php echo __("tn") ?></li>
                </a>
                <!--<a href="/events/demo-tn-review"><li><?php /*echo __("tn_review"); */ ?></li></a>-->
                <a href="/events/demo-tq">
                    <li><?php echo __("tq") ?></li>
                </a>
                <a href="/events/demo-tw">
                    <li><?php echo __("tw") ?></li>
                </a>
                <a href="/events/demo-sun">
                    <li><?php echo __("vsail") ?></li>
                </a>
                <a href="/events/demo-sun-revision">
                    <li><?php echo __("vsail_revision") ?></li>
                </a>
                <a href="/events/demo-sun-review">
                    <li><?php echo __("vsail_review") ?></li>
                </a>
                <a href="/events/demo-sun-odb">
                    <li><?php echo __("odb") . " (" . __("vsail") . ")" ?></li>
                </a>
                <a href="/events/demo-rad">
                    <li><?php echo __("rad") ?></li>
                </a>
                <a href="/events/demo-obs">
                    <li><?php echo __("obs") ?></li>
                </a>
                <a href="/events/demo-bc">
                    <li><?php echo __("bc") ?></li>
                </a>
                <a href="/events/demo-bca">
                    <li><?php echo __("bca") ?></li>
                </a>
            </ul>
        </div>
    </div>
        ...
        <?php foreach ($data["myFacilitatorEventsInProgress"] as $key => $event): ?>
            ...
            <div class="event_block <?php echo $key % 2 == 0 ? $bgColor : "" ?>">
                ...
                <div class="event_action">
                    <div class="event_manage_link"><a href="<?php echo $manageLink ?>"><?php echo __("manage") ?></a>
                    </div>
                    <div class="event_progress_link"><a
                                href="<?php echo $progressLink ?>"><?php echo __("progress") ?></a></div>
...
<div id="my_translations_content" class="my_content">
    <?php foreach ($data["myTranslatorEvents"] as $key => $event): ?>
        ...
        $wordsGroup = isset($event->words) ? (array)json_decode($event->words, true) : [];
            ...
            <div class="event_current_pos">
                <?php if ($event->step != EventSteps::NONE): ?>
                    ...
                    <div class="event_curr_step">
                        ...
                        ?>
                        <img class='img_current'
                             src="<?php echo template_url("img/steps/green_icons/" . $step . ".png") ?>">
            ...
            <div class="event_project">
                ...
                <div class="event_facilitator">
                    ...
                    <div class="facil_names">
                        <?php foreach ($event->admins as $admin): ?>
                            <a href="#"
                               data="<?php echo $admin->memberID ?>"><?php echo $admin->firstName . " " . mb_substr($admin->lastName, 0, 1) . "." ?></a>
                        <?php endforeach; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="event_block <?php echo $key % 2 == 0 ? "lemon-marked" : "" ?>">
            ...
            <div class="event_current_pos">
                <?php if ($event->step != EventCheckSteps::NONE): ?>
                    ...
                    <div class="event_curr_step">
                        <img class='img_current'
                             src="<?php echo template_url("img/steps/green_icons/" . $event->step . ".png") ?>">
                        <div class="step_current">
                            <div>
