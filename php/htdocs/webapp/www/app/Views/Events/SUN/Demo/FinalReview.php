            ...
            <div class="main_content_text">
                ...
                <div class="col-sm-12">
                    <div class="flex_container chunk_block">
                        ...
                        <div class="flex_middle input_draft">
                            <div class="input_editor textarea sun_content"
                                 ...
                                 data-lastmarker="2"
                                 data-totalmarkers="2"><div class="bubble">1</div>    ,             <div class="bubble">2</div>                 </div>
						</div>
                    ...
                    <div class="flex_container chunk_block">
                        ...
                        <div class="flex_middle input_draft">
                            <div class="input_editor textarea sun_content"
                                 data-initialmarker="3"
                                 data-lastmarker="4"
                                 data-totalmarkers="2"><div class="bubble">3</div>  ,  ,                  ”  ,        ,                 </div>
						</div>
                        <div class="flex_right">
                            <?php
                    ...
                    <div class="flex_container chunk_block">
                        ...
                        <div class="flex_middle input_draft">
                            <div class="input_editor textarea sun_content"
                                 data-initialmarker="5"
                                 data-lastmarker="9"
                                 data-totalmarkers="5">    ,           ”                  ,                  ”      ”                  ”        </div>
						</div>
                        <div class="flex_right">
                            <?php
                            $hasComments = false;
                    ...
                    <div class="flex_container chunk_block">
                        ...
                        <div class="flex_middle input_draft">
                            <div class="input_editor textarea sun_content"
                                 data-initialmarker="10"
                                 data-lastmarker="13"
                                 data-totalmarkers="4">    ”       ? “    ”           ,                           </div>
						</div>
                        <div class="flex_right">
                    ...
                    <div class="flex_container chunk_block">
                        ...
                        <div class="flex_middle input_draft">
                            <div class="input_editor textarea sun_content"
                                 data-initialmarker="14"
                                 data-lastmarker="16"
                                 data-totalmarkers="3">                     ”  ,                                 ” </div>
						</div>
                        <div class="flex_right">
                            <?php $enableFootNotes = false;
                            require(app_path() . "Views/Components/Comments.php"); ?>
                    ...
                    <div class="flex_container chunk_block">
                        ...
                        <div class="flex_middle input_draft">
                            <div class="input_editor textarea sun_content"
                                 data-initialmarker="17"
                                 data-lastmarker="18"
                                 data-totalmarkers="2">    ”             ?        ”                </div>
						</div>
                        <div class="flex_right">
                            <?php $enableFootNotes = false;
                            require(app_path() . "Views/Components/Comments.php"); ?>
                    ...
                    <div class="flex_container chunk_block">
                        ...
                        <div class="flex_middle input_draft">
                            <div class="input_editor textarea sun_content"
                                 ...
                                 data-lastmarker="23"
                                 data-totalmarkers="3"> Verse 21 removed in ULB.            ”                ”     </div>
						</div>
                        <div class="flex_right">
                            <?php $enableFootNotes = false;
                            require(app_path() . "Views/Components/Comments.php"); ?>
