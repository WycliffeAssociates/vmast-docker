...
<div>
    <div class="book_title">Bible Commentaries</div>
    <div class="project_title">Matthew - Español</div>
                ...
                <div class="section_content">
                    ...
                    <div class="section_steps">
                        ...
                        <div class="section_step waiting">
                            ...
                            <div class="step_name">2. <?php echo __(EventSteps::PEER_REVIEW . "_bc") ?></div>
