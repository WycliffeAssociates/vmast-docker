    ...
    <div class="help_float">
        <div class="help_info_steps is_checker_page_help">
            ...
            <div class="help_descr_steps">
                <ul>
                    <li><b><?php echo __("purpose") ?></b> <?php echo __("highlight_tn_purpose") ?></li>
                    <li><?php echo __("consume_help_1") ?></li>
                    <li><?php echo __("highlight_tn_help_2") ?>
                        <ol>
                            <li><?php echo __("highlight_tn_help_2a") ?></li>
                            <li><?php echo __("highlight_tn_help_2b") ?></li>
                        </ol>
                    </li>
                    <li><?php echo __("highlight_tn_help_3") ?></li>
