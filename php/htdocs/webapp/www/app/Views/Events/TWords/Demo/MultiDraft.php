    ...
    <div class="help_float">
        <div class="help_info_steps">
            ...
            <div class="help_descr_steps">
                <ul>
                    <li><b><?php echo __("purpose") ?></b> <?php echo __("multi-draft_tw_purpose") ?></li>
                    <li><?php echo __("multi-draft_tw_help_1") ?></li>
                    <li><?php echo __("multi-draft_tq_help_2") ?></li>
                    <li><?php echo __("multi-draft_tw_help_3") ?></li>
                    <li><?php echo __("multi-draft_tq_help_4") ?></li>
                    <li><?php echo __("multi-draft_tw_help_5") ?>
                        <ol>
                            <li><?php echo __("multi-draft_tw_help_5a") ?></li>
                            <li><?php echo __("blind-draft_tn_help_8", ["icon" => "<i class='note-icon-magic'></i>"]) ?></li>
                            <li><?php echo __("multi-draft_tw_help_5c") ?></li>
                            <li><?php echo __("multi-draft_tw_help_5d") ?></li>
                            <li><?php echo __("multi-draft_tw_help_5e") ?></li>
                        </ol>
                    </li>
                    <li><?php echo __("multi-draft_tw_help_6") ?></li>
                    <li><?php echo __("multi-draft_tw_help_7") ?></li>
                    <li><?php echo __("multi-draft_tw_help_8") ?></li>
