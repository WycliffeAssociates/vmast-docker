...
<div class="panel panel-default">
    ...
    <div class="form-inline dt-bootstrap no-footer">
        ...
        <div class="row" id="old_test">
            <div class="project_progress progress <?php echo $data["BCAprogress"] <= 0 ? "zero" : ""?>"
                 style="left: 30px;">
                <div class="progress-bar progress-bar-success" role="progressbar"
                     aria-valuenow="<?php echo floor($data["BCAprogress"]) ?>"
                     aria-valuemin="0" aria-valuemax="100" style="min-width: 0em; width: <?php echo floor($data["BCAprogress"])."%" ?>">
                    <?php echo floor($data["BCAprogress"])."%" ?>
                </div>
            </div>
            <div class="col-sm-12">
...
<div class="event-content form-panel">
    <div class="create-event-content panel panel-default">
        ...
        <div class="page-content panel-body">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form action="/admin/rpc/create_words_event" method="post" id="startEvent">
